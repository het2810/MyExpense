...
function createStyles(theme, insets) {
  return StyleSheet.create({
    ...
    container: {
      ...
      // Trailing space measured from the top of the bottom system bar, so
      // the last preset row / "More options" button never sits under it.
      // 0 where there is no bar — same designed spacing as before.
